...
function UGFunctions() {
    ...
    this.debugVar = "", this.z__________FULL_SCREEN___________ = function() {}, this.toFullscreen = function(e, t) {
        ...
        var s = i.getImageInsideParentData(t, n, r, o, a),
            l = "<img";
        null !== s.imageWidth && (l += " width = '" + s.imageWidth + "'", s.style += "width:" + s.imageWidth + ";"), null != s.imageHeight && ("100%" == s.imageHeight ? (l += " height = '" + s.imageHeight + "'", s.style += "height:" + s.imageHeight + ";") : (l += " height = '" + s.imageHeight + "'", s.style += "height:" + s.imageHeight + "px;")), null !== s.imageTop && (s.style += "top:" + s.imageTop + "px;"), null !== s.imageLeft && (s.style += "left:" + s.imageLeft + "px;"), e = e.replace('"', '"'), l += " style='" + s.style + "'", l += ' src="' + e + '"', l += ">", t.html(l);
...
function UGThumbsStrip() {
    function e(e, i) {
        S = e.getObjects(), z = e, z.attachThumbsPanel("strip", O), T = jQuery(e), P = S.g_objWrapper, x = S.g_arrItems, k = jQuery.extend(k, i), N = k.strip_vertical_type, 1 == N && (k = jQuery.extend(k, Q), k = jQuery.extend(k, i), i.thumb_resize_by = "width"), L.init(e, i), t()
    }
    ...
    function n() {
        L.setHtmlProperties(), o(), l(), s(), 0 == R.isRunOnce && (1 == k.strip_control_touch && (M = new UGTouchThumbsControl,
            M.init(O)), 1 == k.strip_control_avia && (A = new UGAviaControl, A.init(O)), p(), L.loadThumbsImages(), y()), R.isRunOnce = !0
    }

    function r(e) {
        G.stripSize = e, 0 == N ? G.stripActiveSize = G.stripSize - k.strip_padding_left - k.strip_padding_right : G.stripActiveSize = G.stripSize - k.strip_padding_top - k.strip_padding_bottom, G.stripActiveSize < 0 && (G.stripActiveSize = 0)
    }
    ...
    function a(e) {
        0 == N ? C.width(e) : C.height(e), G.stripInnerSize = e, p(), jQuery(O).trigger(O.events.INNER_SIZE_CHANGE)
    }
    ...
    function f() {
        return I() ? !1 : void(0 == N ? H.placeElement(C, k.strip_thumbs_align, 0) : H.placeElement(C, 0, k.strip_thumbs_align))
    }
    ...
    this.setHtml = function(e) {
        ...
        return 0 == N ? C.position().left : C.position().top
    }, this.getInnerStripLimits = function() {
        var e = {};
        return 0 == N ? e.maxPos = k.strip_padding_left : e.maxPos = k.strip_padding_top, e.minPos = -(G.stripInnerSize - G.stripActiveSize), e
        ...
        k = jQuery.extend(k, e), L.setOptions(e), t()
        ...
        H.placeElement(j, e, t, i, n)
    }, this.resize = function(e) {
        0 == N ? (j.width(e), G.stripActiveSize = e - k.strip_padding_left - k.strip_padding_right) : (j.height(e), G.stripActiveSize = e - k.strip_padding_top - k.strip_padding_bottom), r(e), p(), h(), f(), c()
    }, this.setThumbUnselected = function(e) {
        L.setThumbUnselected(e)
        ...
        return -1 == e ? null : L.getThumbByIndex(e)
    }, this.getSizeAndPosition = function() {
        var e = H.getElementSize(j);
        return e
...
function UGGridPanel() {
    ...
    function d() {
        return 1 == H.isEventsInited ? !1 : (H.isEventsInited = !0, T && (j.addClassOnHover(T), C.attachPrevPaneButton(T)), E && (j.addClassOnHover(E), C.attachNextPaneButton(E)), void A.initEvents())
    }
    ...
    function b() {
        1 == H.arrowsVisible ? m() : v()
    }

    function y() {
        0 == H.isHorType ? 1 == M.gridpanel_vertical_scroll ? h() : f() : b(), A.placeElements()
    }
    var I, w, E, T, S = this,
        P = jQuery(this),
...
function UGThumbsGrid() {
    ...
    function d(e) {
        var t = T(e);
        return -1 == t ? !1 : void D.gotoPane(t, "scroll")
    }
    ...
    this.destroy = function() {
        ...
        var e = X.currentPane - 1;
        return 0 > e && (e = X.numPanes - 1, 0 == V.grid_carousel) ? !1 : void D.gotoPane(e, "prev")
    }, this.attachNextPaneButton = function(e) {
        return B.setButtonOnClick(e, D.nextPane), 1 == V.grid_carousel ? !0 : (D.isLastPane() && e.addClass("ug-button-disabled"), void W.on(D.events.PANE_CHANGE, function() {
            D.isLastPane() ? e.addClass("ug-button-disabled") : e.removeClass("ug-button-disabled")
        }))
    }, this.attachPrevPaneButton = function(e) {
        return B.setButtonOnClick(e, D.prevPane), 1 == V.grid_carousel ? !0 : (D.isFirstPane() && e.addClass("ug-button-disabled"), void W.on(D.events.PANE_CHANGE, function() {
            D.isFirstPane() ? e.addClass("ug-button-disabled") : e.removeClass("ug-button-disabled")
        }))
    }, this.attachBullets = function(e) {
        e.setActive(X.currentPane), jQuery(e).on(e.events.BULLET_CLICK, function(t, i) {
            D.gotoPane(i, "theme"), e.setActive(i)
        }), jQuery(D).on(D.events.PANE_CHANGE, function(t, i) {
            e.setActive(i)
        })
...
function UGTiles() {
    ...
    function y() {
        var e = jQuery(K).find("img.ug-thumb-image"),
            t = se.getThumbs();
        t.fadeTo(0, 0), oe.checkImagesLoaded(e, function() {
            1 == re.isMobileMode() ? g(!0) : w(!0), ne.trigger(ie.events.TILES_FIRST_PLACED), n()
        }, function(e, t) {
            e = jQuery(e);
            var i = jQuery(e).parent();
            se.triggerImageLoadedEvent(i, e)
    ...
    function O(e, t) {
        ...
        for (var _ = n, g = [], s = r.length - 1; s >= 0; s--) {
            var c, l = r[s][0];
            0 != s ? (c = Math.max(Math.round(1 * n / 3), Math.floor(r[s][1] * (n / i))), _ -= c, d = L(l, c, !0), d.left = o, d.top = a, g.push({
                tileID: l,
                sizes: d
            }), a += d.dimHeight) : (c = _, d = L(l, c, !0), d.left = o, d.top = a, g.push({
                tileID: l,
                sizes: d
            }))
        }
...
function UGTileDesign() {
    ...
    function n(e, t) {
        ...
        r = D.htmlentitles(r), i += "<img src='" + t.urlThumb + "' alt='" + r + "' class='" + n + "'>", 1 == Y.hasImageContainer && (i += "</div>"), e.append(i), F.tile_size_by == R.sizeby.GLOBAL_RATIO && e.fadeTo(0, 0);
        var o = {};
        ...
        if (1 == F.tile_enable_image_effect) {
            ...
            f += "<img src='" + t.urlThumb + "' alt='" + t.title + "' class='" + m + p + "'>", f += "</div>", e.append(f), 1 == F.tile_image_effect_reverse && e.children(".ug-tile-image-overlay").fadeTo(0, 0)
        }
    ...
    this.loadTileImage = function(e) {
        ...
        D.checkImagesLoaded(t, null, function(t, i) {
            C(null, e, jQuery(t))
        })
    }, this.setHtml = function(e) {
        N = e, i(), W.setHtmlThumbs(e)
    }, this.initEvents = function() {
        W.initEvents(), jQuery(W).on(W.events.SETOVERSTYLE, S), jQuery(W).on(W.events.SETNORMALSTYLE, P), jQuery(W).on(W.events.PLACEIMAGE, C), L.on(Y.eventSizeChange, j), N.delegate(".ug-tile .ug-button-play", "click", O), N.delegate(".ug-tile", "click", M), N.delegate(".ug-tile .ug-icon-link", "click", z)
    }, this.destroy = function() {
        ...
        return t && 1 == Y.isTextpanelOutside && F.tile_size_by == R.sizeby.IMAGE_RATIO && (n += g(t)), n
...
function UGSlider() {
    ...
    function p(e, t, i) {
        ...
        if (objPadding = pe.getObjImagePadding(), a == o && i !== !0) {
            ...
            c(u, l, g), fe.trigger(pe.events.AFTER_PUT_IMAGE, e)
...
function UGZoomSliderControl() {
    ...
    function c(e) {
        var t = T.getArrTouches(e),
            ...
            l = 1;
        if (s.width > 0 && (l = o / s.width),
            l > S.slider_zoom_max_ratio) return !0;
    ...
    function fillItemsArray(e) {
        ...
        for (var i = t.isMobileMode(), n = 0, r = 0; r < e.length; r++) {
            ...
            if (u.type = l, "img" == a) {
                ...
                var _ = o.attr("src"),
                    g = o.data("thumb");
                "undefined" != typeof g && "" != g ? (u.urlThumb = g, u.urlImage = _, o.attr("src", g)) : (u.urlThumb = _, u.urlImage = o.data("image")), u.title = o.attr("alt"), u.objThumbImage = o
            } else {
                if ("image" == l) throw new Error("The item should not be image type");
                u.urlThumb = o.data("thumb"), u.title = o.data("title"), u.objThumbImage = null, u.urlImage = o.data("image")
            }
            if (1 == i) {
                var c = o.data("thumb-mobile");
                "undefined" != typeof c && "" != c && (u.urlThumb = c, "img" == a && o.attr("src", u.urlThumb));
                var h = o.data("image-mobile");
                "undefined" != typeof h && "" != h && (u.urlImage = h)
            }
            ...
            var p = o.data("width"),
                f = o.data("height");
            p && "number" == typeof p && f && "number" == typeof f && (u.thumbWidth = p, u.thumbHeight = f, u.thumbRatioByWidth = p / f, u.thumbRatioByHeight = f / p), u.addHtml = null;
            var m = void 0 == u.urlImage || "" == u.urlImage,
                v = void 0 == u.urlThumb || "" == u.urlThumb;
            switch (u.type) {
                case "youtube":
                    if (u.videoid = o.data("videoid"), m || v) {
                        var b = g_ugYoutubeAPI.getVideoImages(u.videoid);
                        m && (u.urlImage = b.preview), v && (u.urlThumb = b.thumb, "img" == a && o.attr("src", u.urlThumb))
                    }
                ...
                case "wistia":
                    ...
                    break;
                case "custom":
                    var y = o.children("img");
                    y.length && (y = jQuery(y[0]), u.urlThumb = y.attr("src"), u.title = y.attr("alt"), u.objThumbImage = y);
                    var I = o.children().not("img:first-child");
                    I.length && (u.addHtml = I.clone())
            }
...
function UGLightbox() {
    ...
    function B() {
        if (X.on("touchstart", function(e) {
                ...
                ee.close("button")
            }), U.on(ie.events.ITEM_CHANGE, H), ne) {
        ...
        jQuery(window).resize(function() {
            return 0 == se.isOpened ? !0 : void re.whenContiniousEventOver("lightbox_resize", L, 100)
        }), U.on(ie.events.GALLERY_KEYPRESS, G), 1 == se.isArrowsOnHoverMode && jQuery(document).bind("mousemove", W), V.on("mousewheel", F)
    }

    function Y() {
        se.isCompact = !1, t(), ae = jQuery.extend({}, se.originalOptions), ne.setOptions(ae)
    }
...
function UGCarousel() {
    function e(e, t) {
        g_objects = e.getObjects(), W = e, N = jQuery(e), L = g_objects.g_objWrapper, k = g_objects.g_arrItems, U = jQuery.extend(U, t), B.setFixedMode(), B.setApproveClickFunction(H), B.init(e, U), Y = B.getObjThumbs(), U = B.getOptions(), V.initTileWidth = U.tile_width, V.initTileHeight = U.tile_height, V.tileWidth = U.tile_width
    }
    ...
    function n() {
        ...
        n += 2 * U.carousel_padding, R.width(n), 1 == V.isFirstTimeRun ? (z(), B.run(), jQuery.each(k, function(e, t) {
            t.objThumbWrapper.data("index", e), L.trigger(V.eventSizeChange, [t.objThumbWrapper, !0]), t.objTileOriginal = t.objThumbWrapper.clone(!0, !0)
    ...
    function b(e, t) {
        ...
        jQuery.each(r, function(e, i) {
            "left" == t ? G.prepend(i) : G.append(i), L.trigger(V.eventSizeChange, i), B.loadTileImage(i)
        })
    }
    ...
    function A(e) {
        return 0 == V.touchActive ? !0 : (V.touchActive = !1, T(), void Q.unpauseAutoplay())
    }
